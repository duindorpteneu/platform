...
export default async function MembersPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return <MemberOverview list={overview.list} detail={overview.detail} query={overview.query} savedViews={overview.savedViews} staffRole={overview.staff.role} packageOptions={overview.packageOptions} />;
}
