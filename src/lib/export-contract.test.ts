...
describe("export contract", () => {
  it("accepts the six legacy and two first-class package export types", () => {
  ...
  it("rejects non-primitive row values and unknown workspace fields", () => {
    const base = { type: "members", seasonName: "2026 / 2027", generatedAt: "2026-07-18T10:00:00+02:00", columns: [{ key: "name", label: "Naam" }] };
