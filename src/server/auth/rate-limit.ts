...
export async function consumeRateLimit(client: RateLimitClient, input: { scope: "otp_request" | "otp_verify" | "mollie_create" | "export" | "search" | "supplier_login" | "staff_recovery"; keyHash: string; limit: number; windowSeconds: number }) {
