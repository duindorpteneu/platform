...
const names = ["NEXT_PUBLIC_SUPABASE_ANON_KEY", "SUPABASE_SERVICE_ROLE_KEY", "SUPABASE_DB_URL", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY", "PARENT_TOKEN_PEPPER", "CRON_SECRET", "MOLLIE_API_KEY", "SENDGRID_API_KEY"];
