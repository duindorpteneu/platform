...
- Forward migration `20260821183154` bevriest de cutoverset atomair: iedere outcome-loze pre-v3-poging krijgt een exacte, geaudite `delivery_uncertain`-uitkomst. Dat sluit de afleverledger eerlijk af zonder de afzonderlijke code/linkchallenge te consumeren. De nieuwe rollbackcompatibele health v14 en v15 sluiten uitsluitend deze vastgelegde incidentversies uit; iedere post-cutovergap of -onzekerheid blijft blokkeren.
- Lokale migration lint, production-like upgradefixture, 225 Vitestbestanden/1.384 tests, 60 pgTAP-bestanden/1.997 assertions, lint, TypeScript, workflowlint en productiebuild zijn groen. Protected PR-CI, merged-main-CI en stagingredeploy volgen.
