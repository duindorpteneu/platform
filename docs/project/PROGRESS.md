...
## Next
- Bouw nu het forward-only lid-seizoen-/DOB-/toegangsmodel; voeg daarna pakketten, dynamische import, allocatie, QR-exchange, mails en scanner-PWA als verticale slices toe.
