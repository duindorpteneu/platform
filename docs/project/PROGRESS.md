...
- De eerste exact-main stagingdeploy stopte vóór appvervanging op de bestaande immutable OTP-ledgertrigger tijdens recipientbackfill. Twee forward-only, volgordevaste compatibiliteitsmigraties laten uitsluitend de historische null-identitybinding toe en herstellen onmiddellijk de strikte guard; een nieuwe upgradegate reproduceert exact dit niet-lege stagingpad.
