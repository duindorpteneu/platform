...
- Volledige lokale gate: dependency-audit zonder bekende kwetsbaarheden, secretscan, 137 forward-only migrations, actionlint, ESLint, TypeScript, 197 Vitestbestanden/1.193 tests en production build groen.
