...
- Gerichte regressies bewaken één gedeelde sessie-TTL binnen de databasegrens voor code én directe link, gelijke cookie-TTL, en cleanup die alleen run-nieuwe challenges sluit. Een nieuwe protected release- en acceptatierun blijft vereist voordat deze hosted gate groen wordt gemarkeerd.
