...
- Exacte stagingrun `29853445078` poging 2 maakte de beheerderfixture aantoonbaar gereed en isoleerde daarna een minutenlang open sessieresponse. De oorzaak zat in de raw PostgREST-client: responseheaders beëindigden de AbortController terwijl de body nog niet gelezen was. De client wacht de JSON-body nu binnen dezelfde deadline af; gerichte Vitestdekking simuleert dit exacte half-open antwoord en onderscheidt JWT- van sessietransportuitval.
